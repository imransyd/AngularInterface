  ...
  export class AppComponent implements OnInit {
    ...
    updateApt(aptInfo) {
      let aptIndex: number;
      let modifiedIdnex: number;

      aptIndex = findIndex(this.theList, { aptId: aptInfo.theApt.aptId });
      modifiedIdnex = findIndex(this.modifiedList, { aptId: aptInfo.theApt.aptId });

      this.theList[aptIndex][aptInfo.labelName] = aptInfo.newValue;
      this.modifiedList[modifiedIdnex][aptInfo.labelName] = aptInfo.newValue;
    }
    ...
    searchApt(theQuery: string){
      ...
      this.sortItems();// call that sorting function when you are searching through things.
    }
